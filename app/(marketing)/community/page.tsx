    ...
    <div className="min-h-screen bg-paper">
      <section className="bg-grid-blueprint py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-graphite-900">Join our community</h1>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="bg-paper rounded-3xl shadow-soft p-8">
              <span className="stamp-label">Chat</span>
              ...
              <a
                ...
                className="btn-press rounded-full inline-flex items-center gap-2 bg-redpen-600 text-white text-sm font-semibold px-6 py-3 shadow-red-glow hover:bg-redpen-700"
              >
                Join the Discord
              </a>
            </div>
            ...
            <div className="bg-paper rounded-3xl shadow-soft p-8">
              <span className="stamp-label">Get Involved</span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn-press rounded-full inline-flex items-center gap-2 bg-graphite-900 text-white text-sm font-semibold px-6 py-3 hover:bg-graphite-700"
              >
                Volunteer Now
              </a>
            </div>
            ...
            {/* Contact Section */}
            <div className="bg-graphite-900 rounded-3xl p-8">
              <h2 className="text-xl font-bold text-white mb-3">Get in touch</h2>
              <p className="text-graphite-300 mb-3">
                Have questions or want to learn more about our programs? We&apos;d love to hear from you.
              </p>
              <p className="text-graphite-300">
                Email us at{' '}
                <a href="mailto:support@canadianmathleague.ca" className="text-white underline hover:text-redpen-400">
                  support@canadianmathleague.ca
                </a>{' '}
                or use our{' '}
                <a href="/contact" className="text-white underline hover:text-redpen-400">
                  contact form
                </a>
                .
              </p>
