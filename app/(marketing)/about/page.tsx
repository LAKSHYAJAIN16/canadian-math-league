      ...
      >
        {src ? (
          <div className="h-14 w-full flex items-center justify-center">
            ...
            />
            <span className={`font-mono text-xs ${isCanadian ? 'text-stamp-600' : 'text-ink-700'} text-center hidden`}>
              {alt}
            </span>
          </div>
        ) : (
          <span className={`font-mono text-xs ${isCanadian ? 'text-stamp-600' : 'text-ink-700'} text-center`}>
            {alt}
          </span>
        )}
      </motion.div>
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-ledger">
      ...
      {/* Letter Section */}
      <section className="py-16 bg-ledger-deep">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-ink-700 leading-relaxed">
              <div className="space-y-1">
                <div className="font-sans text-2xl text-stamp-600">You deserve more.</div>
