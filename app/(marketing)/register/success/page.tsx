    ...
    <div className="min-h-screen bg-ledger flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        >
          ...
          <span className="mt-5 inline-block font-mono text-[0.625rem] font-semibold uppercase tracking-wide border border-stamp-600 text-stamp-600 px-2 py-1">
            Registered
          </span>
          ...
          <Link
            href="/"
            className="btn-press mt-6 w-full flex justify-center items-center gap-2 py-3.5 font-mono text-sm font-semibold uppercase tracking-wide text-ledger bg-stamp-600 hover:bg-stamp-700"
          >
            Return to Home
          </Link>
