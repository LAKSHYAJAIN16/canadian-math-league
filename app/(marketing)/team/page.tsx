    ...
    <div className="min-h-screen bg-paper">
      <section className="bg-grid-blueprint py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blueprint-100 mt-4">Meet the people behind the Canadian Math League.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="bg-paper border-2 border-graphite-900 rounded-xl p-8 text-center"
              >
                <div className="w-24 h-24 mx-auto mb-5 border-2 border-graphite-900 rounded-xl bg-blueprint-800 flex items-center justify-center">
