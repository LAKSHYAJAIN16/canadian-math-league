...
export default function CommunityPage() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24 -mt-20">
        <motion.div
        ...
        >
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
              ...
              <p>
                Email us at <a href="mailto:support@canadianmathleague.com" className="text-blue-600 hover:underline">support@canadianmathleague.com</a> or use our contact form.
              </p>
            </div>
          </div>
        </motion.div>
